...
const UploadCover = () => {
  const { setOpen, coverPreview, removeCover } = useSelectCoverImageStore();
  ...
  return (
    <DefaultCard
      ...
      className="w-[214px] h-[320px] relative bg-card flex items-center justify-center overflow-hidden cursor-pointer border-none"
    >
      {coverPreview ? (
        <>
          <Image
